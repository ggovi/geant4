...
class G4ParticleHPCaptureDataProxy;

class G4ParticleHPCaptureData : public G4ParticleHPNeutronXSDataSet
{
   public:
      static constexpr const char* const MODEL_NAME = "Capture";
   ...
   private:
      ...
      std::unique_ptr<G4ParticleHPCaptureDataProxy> theMgrProxy;
