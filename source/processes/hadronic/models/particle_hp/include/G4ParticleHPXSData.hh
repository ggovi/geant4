...
//
#ifndef G4ParticleHPXSData_h
#define G4ParticleHPXSData_h 1
...
public:
  ...
  ~G4ParticleHPXSData(){ delete theChannelData; }
  ...
  void Init( G4int A, G4int Z, G4int M, G4double abun, G4String dataFolder, G4int ZThreshold );
  
  inline G4ParticleHPVector * Make()
    {return theData;}
  ...
  {
    if(theData) theData->ThinOut(precision);
  }
